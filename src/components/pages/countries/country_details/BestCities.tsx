    ...
    >
      <div className="container">
        <div className="flex flex-wrap items-start justify-center gap-10">
          <FadeInUpWithSlowBounce className="min-h-[200px] w-[180px] space-y-4">
            <div className="mx-auto size-[150px] rounded-full bg-white p-1">
              <div className="relative mx-auto min-h-full">
                <Image
                  ...
                  src="/images/pages/countries/best_cities/1.jpg"
                  alt="romania"
                  fill
                />
              </div>
            </div>
            <h3 className="text-center text-2xl font-bold">romania</h3>
