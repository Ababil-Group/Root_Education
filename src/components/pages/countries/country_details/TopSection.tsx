        ...
        <div className="basis-full space-y-6 lg:basis-[60%]">
          ...
          <div className="space-y-3">
            <p className="text-sm font-medium">
              {countryInfo.country} is an increasingly popular destination for
              Bangladeshi students seeking a high-quality European education at
              an affordable cost. Renowned for its strong academic tradition,
              {countryInfo.country} offers a wide range of programs in English
              across various fields, including engineering, medicine, business,
              and the arts. Universities in {countryInfo.country} are recognized
              for their rigorous curricula, modern facilities, and opportunities
            ...
            <p className="text-sm font-medium">
              Additionally, {countryInfo.country}&apos;s central location in
              Europe allows students to explore neighboring countries and
              cultures, enhancing their educational experience. With degrees
              recognized across the European Union and beyond, a{" "}
              {countryInfo.country}
